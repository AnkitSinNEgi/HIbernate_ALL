...
//Create Entity Address
		...
		add.setAddress("Marathali");
		
		Address add2 = new Address();
		add2.setAddress("Mejistic");
											

//Storing Address
		emanager.persist(add);	
		emanager.persist(add2);
		
// Create book Entity
		Books book1 = new Books();
		book1.setBname("Economics");
		
		Books book2 = new Books();
		book2.setBname("Data Structure");
		
		Books book3 = new Books();
		book3.setBname("Mathematics");
...
//		lap2.setLmodel("Lenovo G50");
//		lap2.setStudentList(studlist);
							
// Storing Laptop Entity
		emanager.persist(lap1);
//		emanager.persist(lap2);
